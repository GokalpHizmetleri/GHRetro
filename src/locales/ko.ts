...
export const translation: ResourceLanguage = {
  ...
  Retry: '재시도',
  review_dash:
    'GHRetro는 또 하나의 에뮬레이터 프런트엔드나 ROM 관리 도구가 아니라, 장애물만 치우면 레트로 게임이 얼마나 단순하고 즐거울 수 있는지를 다시 떠올리게 해 주는 서비스입니다. 핵심은 클래식 게임들을 언제 어디서나 쉽게 찾고, 쉽게 실행하고, 손쉽게 가지고 다닐 수 있게 만드는 데 있습니다. 내부의 기술은 최신이지만, 철학은 순도 100%의 8비트 감성입니다. 게임을 고르고, 스타트 버튼을 누르면, 그 순간 바로 모험이 시작됩니다.',
  review_jim_gray:
    '손 안에 방대한 레트로 게임 라이브러리를 갖고 있는 것만으로는 충분하지 않습니다. 정작 휴대용 게임기를 집에 두고 왔다면 아무 소용이 없으니까요. 이달의 추천 게임을 시작해 보려고 할 때, 이런저런 이유로 그 게임이 기기 안에 없다는 사실을 깨닫게 될 수도 있습니다. GHRetro는 바로 이런 상황을 해결하고자 합니다. 여러분의 전체 컬렉션을 브라우저 하나로 언제든지 불러올 수 있게 해 주죠.',
  review_korben:
    'GHRetro는 브라우저 탭 안에 쏙 들어가는 개인용 레트로 게임 스테이션입니다. 설치도 필요 없고, 복잡한 설정도 없습니다. 그저 여러분의 레트로 게임 컬렉션을 어떤 기기에서든 바로 즐길 수 있을 뿐입니다. 이 플랫폼을 잠깐만 써 보면, 마치 어린 시절 게임하던 내 방을 다시 찾은 듯한 기분이 들 겁니다….',
  review_robert_triggs:
    'GHRetro 덕분에 게임 라이브러리 관리는 더 이상 귀찮은 일이 아니라 즐거운 일이 되었습니다. 설정은 간단하고, 사용은 매우 직관적이며, 제 모든 기기에서 잘 동작합니다. 이제는 이리저리 만지작거리는 시간을 줄이고, 실제로 게임을 하는 데 더 많은 시간을 쓸 수 있게 되었습니다.',
  Reviews: '리뷰',
  Rewind: '되감기',
