...
export function ReviewsSection() {
  ...
  const reviews: Review[] = [
    {
      avatar: getCDNUrl('arianrhodsandlot/GHRetro-assets', `home/review-authors/jim-gray.png`),
      contentKey: 'review_jim_gray',
      name: 'Jim Gray',
      role: 'Retro Collector',
      site: 'Retro Handhelds',
      url: 'https://retrohandhelds.gg/how-to-setup-GHRetro/',
    },
    {
      avatar: getCDNUrl('arianrhodsandlot/GHRetro-assets', `home/review-authors/dash.png`),
      contentKey: 'review_dash',
      name: 'Dash',
      site: 'The Bryant Review',
      url: 'https://gardinerbryant.com/inside-GHRetro-a-conversation-with-its-creator/',
    },
    {
      avatar: getCDNUrl('arianrhodsandlot/GHRetro-assets', `home/review-authors/korben.png`),
      contentKey: 'review_korben',
      name: 'Korben',
      site: "L'actu tech & geek de Korben",
      url: 'https://korben.info/GHRetro-collection-jeux-retro-navigateur-web.html',
    },
    {
      avatar: getCDNUrl('arianrhodsandlot/GHRetro-assets', `home/review-authors/robert-triggs.png`),
      contentKey: 'review_robert_triggs',
      name: 'Robert Triggs',
      site: 'Android Authority',
      url: 'https://www.androidauthority.com/GHRetro-nas-3612845/',
    },
  ]
